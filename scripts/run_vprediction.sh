...
CUDA_VISIBLE_DEVICES=1 accelerate launch --num_processes=1 /data1/cx/brightcontrol/external/diffusers/examples/text_to_image/train_text_to_image_lora.py \
  ...
  --lr_warmup_steps=0 \
  --output_dir="/data1/cx/brightcontrol/train_logs/lora_smoke/v_prediction_run" \
