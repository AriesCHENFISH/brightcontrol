...
export OUT_DIR="/data1/cx/brightcontrol/train_logs/final_ablation/offset005_vpred_1500"

mkdir -p "$OUT_DIR"

echo "Starting offset005 + v_prediction ablation training"
echo "Model: $MODEL_NAME"
echo "Train data: $TRAIN_DIR"
echo "Output: $OUT_DIR"
echo "Max steps: 1500"
echo "Checkpoint steps: 300"
echo "noise_offset=0.05, prediction_type=v_prediction, rank=8"
...
CUDA_VISIBLE_DEVICES=4 accelerate launch --num_processes=1 --main_process_port=29502 \
